...
namespace OpenDentBusiness {
	...
	public class LargeTableHelper {
		...
		///<summary>NOT Oracle compatible.  Do NOT try-catch this method, even when only adding an index.
		///This will rename the table specified to be preceded by "convTmp_"+tableName+"random number", creates a copy of
