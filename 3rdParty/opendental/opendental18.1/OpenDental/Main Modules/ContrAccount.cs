...
namespace OpenDental {
	...
	public class ContrAccount:System.Windows.Forms.UserControl {
		...
		private void AddAdjustmentToSelectedProcsHelper(bool openMultiAdj=false) {
			...
			else if(openMultiAdj) {
				//user clicked the multi adjustment menuitem.
				//No procedures were selected, open the multi adjustment form without any passed in procedures.
				FormAdjMulti FormAM=new FormAdjMulti(PatCur);
				FormAM.ShowDialog();
			}
			else {
